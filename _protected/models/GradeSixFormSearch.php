...
use app\models\GradeSixForm;

/**
 * GradeSixFormSearch represents the model behind the search form about `app\models\GradeSixForm`.
 */
class GradeSixFormSearch extends GradeSixForm
{
    /**
     * @inheritdoc
     */
