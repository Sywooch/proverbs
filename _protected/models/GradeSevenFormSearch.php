...
/**
 * GradeSevenFormSearch represents the model behind the search form about `app\models\GradeSevenForm`.
 */
class GradeSevenFormSearch extends GradeSevenForm
{
    /**
     * @inheritdoc
     */
