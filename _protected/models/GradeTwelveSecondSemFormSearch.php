...
use app\models\GradeTwelveSecondSemForm;

/**
 * GradeTwelveSecondSemFormSearch represents the model behind the search form about `app\models\GradeTwelveSecondSemForm`.
 */
class GradeTwelveSecondSemFormSearch extends GradeTwelveSecondSemForm
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = GradeTwelveSecondSemForm::find();
