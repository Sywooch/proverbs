...
/**
 * GradeElevenSecondSemFormSearch represents the model behind the search form about `app\models\GradeElevenSecondSemForm`.
 */
class GradeElevenSecondSemFormSearch extends GradeElevenSecondSemForm
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = GradeElevenSecondSemForm::find();
