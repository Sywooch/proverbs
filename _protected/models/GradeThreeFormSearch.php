...
use app\models\GradeThreeForm;

/**
 * GradeOneFormSearch represents the model behind the search form about `app\models\GradeOneForm`.
 */
class GradeThreeFormSearch extends GradeOneForm
{
    /**
     * @inheritdoc
     */
