...
use app\models\GradeNineForm;

/**
 * GradeNineFormSearch represents the model behind the search form about `app\models\GradeNineForm`.
 */
class GradeNineFormSearch extends GradeNineForm
{
    /**
     * @inheritdoc
     */
