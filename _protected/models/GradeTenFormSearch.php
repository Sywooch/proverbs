...
use app\models\GradeTenForm;

/**
 * GradeTenFormSearch represents the model behind the search form about `app\models\GradeTenForm`.
 */
class GradeTenFormSearch extends GradeTenForm
{
    /**
     * @inheritdoc
     */
