...
use app\models\GradeEightForm;

/**
 * GradeEightFormSearch represents the model behind the search form about `app\models\GradeEightForm`.
 */
class GradeEightFormSearch extends GradeEightForm
{
    /**
     * @inheritdoc
     */
