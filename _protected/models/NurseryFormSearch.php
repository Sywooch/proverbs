...
/**
 * NurseryFormSearch represents the model behind the search form about `app\models\NurseryForm`.
 */
class NurseryFormSearch extends NurseryForm
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'grade_protection', 'enrolled_id', 'grading_period', 'core_value_1', 'core_value_2', 'core_value_3', 'core_value_4', 'subject_1', 'subject_2', 'subject_3', 'subject_4', 'subject_5'], 'integer'],
        ];
    }
