...
/**
 * GradeTwelveFirstSemFormSearch represents the model behind the search form about `app\models\GradeTwelveFirstSemForm`.
 */
class GradeTwelveFirstSemFormSearch extends GradeTwelveFirstSemForm
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = GradeTwelveFirstSemForm::find();
