...
use app\models\GradeFiveForm;

/**
 * GradeFiveFormSearch represents the model behind the search form about `app\models\GradeFiveForm`.
 */
class GradeFiveFormSearch extends GradeFiveForm
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'grade_protection', 'enrolled_id', 'grading_period', 'core_value_1', 'core_value_2', 'core_value_3', 'core_value_4', 'subject_1', 'subject_2', 'subject_3', 'subject_4', 'subject_5', 'subject_6', 'subject_7', 'subject_8'], 'integer'],
        ];
    }
