 ...
 */
class GradeTwelveSecondSemForm extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function attributeLabels()
    {
        return [
            ...
            'subject_1' => '21st Century from the Philippines and the World',
            'subject_2' => 'Fundamentals of Accountanct 2',
            'subject_3' => 'Research 2',
            'subject_4' => 'Contemporary Philippine Arts from the Regions',
            'subject_5' => 'Media and Information Technology',
            'subject_6' => 'Elective 2',
            'subject_7' => 'Animation',
            'subject_8' => 'Computer Programming',
            'subject_9' => 'Food and Beverage',
            'subject_10' => 'Performing Arts Production',
        ];
    }
