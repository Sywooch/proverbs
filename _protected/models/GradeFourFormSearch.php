...
/**
 * GradeFourFormSearch represents the model behind the search form about `app\models\GradeFourForm`.
 */
class GradeFourFormSearch extends GradeFourForm
{
    /**
     * @inheritdoc
     */
