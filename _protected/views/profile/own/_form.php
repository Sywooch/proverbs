        ...
        <div class="panel panel-default rounded-edge">
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <?= $form->field($model, 'birth_date', ['inputTemplate' => '<label>Birth Date</label>{input}','inputOptions' => [] ])->label(false)->textInput(['class' => 'form-control pva-form-control'], ['maxlength' => true]) ?>
                    </div>
                </div>
                <div class="row">
