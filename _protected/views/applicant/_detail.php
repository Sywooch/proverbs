...
<div class="ui tab segment active" data-tab="first">
    ...
    <?php Pjax::begin(['id' => 'applicant-list1', 'timeout' => 5000, 'enablePushState' => false]); ?>
		<?= UiTable::widget([
		    'model' => $model,
...
<div class="ui tab segment hidden" data-tab="second">
	...
	<?php Pjax::begin(['id' => 'applicant-list2', 'timeout' => 5000, 'enablePushState' => false]); ?>
		<?= UiTable::widget([
		    'model' => $model,
		    'options' => ['class' => 'ui fixed very basic table'],
		    'attributes' => [
			...
			<div class="ui items">
				<div class="item">
					...
					<div class="content">
						...
						<?php Pjax::begin(['id' => 'applicant-list3', 'timeout' => 5000, 'enablePushState' => false]); ?>
							<?= UiTable::widget([
								'model' => $model,
								'options' => ['class' => 'ui fixed very basic table'],
								'attributes' => [
...
<div class="ui tab segment hidden" data-tab="fourth">
	...
	<?php Pjax::begin(['id' => 'applicant-list4', 'timeout' => 5000, 'enablePushState' => false]); ?>
		<?= UiTable::widget([
		    'model' => $model,
		    'options' => ['class' => 'ui fixed very basic table'],
		    'attributes' => [
...
<div class="ui tab segment hidden" data-tab="fifth">
	...
	<?php Pjax::begin(['id' => 'applicant-list5', 'timeout' => 5000, 'enablePushState' => false]); ?>
		<?= UiTable::widget([
		    'model' => $model,
		    'options' => ['class' => 'ui fixed very basic table'],
		    'attributes' => [
