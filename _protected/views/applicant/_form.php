    ...
    <div class="nine wide rounded column">
        <div id="student-info-menu">
            <div class="ui five item pointing menu stackable">
                <a class="item active" data-tab="first">Applicant</a>
                ...
                <div class="ui tab segment active" data-tab="first">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <?= //PRINCIPALS VIEW
                                $form->field($model, 'status', ['inputTemplate' => '<label>Status</label>{input}'])->dropDownList([1=> 'Student', 2 => 'Applicant'],['class' => 'form-control pva-form-control'])->label(false)?>
                        </div>
                    </div>
                    <div class="row">
