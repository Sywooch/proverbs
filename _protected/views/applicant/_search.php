...
<div class="ui fluid vertical menu">
    <div class="item">
        <?= Html::a('More', '#applicant-filters-more' , ['class' => 'ui right floated small basic button collapsed', 'role' => 'button', 'data-toggle' => 'collapse', 'aria-expanded' => 'false', 'aria-controls' => 'applicant-filters-more', 'aria-expanded' => 'false'])?>
    ...
    <div class="item">
        <div class="collapse" id="applicant-filters-more">
            <p></p>
            ...
            <?= $form->field($model, 'gender', ['inputTemplate' => '<label for="Gender">Gender</label>{input}'])->dropDownList($model->getGenderList(), ['class' => 'form-control pva-form-control'])->label(false) ?>
            <?= $form->field($model, 'grade_level_id', ['inputTemplate' => '<label for="Grade Level">Grade Level</label>{input}'])->dropDownList($model->getLevelList(), ['class' => 'form-control pva-form-control'])->label(false) ?>
